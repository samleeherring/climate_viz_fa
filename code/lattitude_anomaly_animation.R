...
anim_df <- factor_8[!duplicated(factor_8$rows),] %>%
  ...
  #        segment_alpha = pmax(0, (10-tail)/10))
...
anim_df %>%
  ...
  # geom_label(aes(x =4, y=9, label = year),
  ...
  transition_manual(frames = year_number)
  # 
  # labs(
  #   x = "Temperature anomaly (\u00B0C)",
  #   y = NULL,
  #   title = "Variation in annual temperature anomaly by latitude (1880-2024)"
  # ) +
  # 
  # theme(
...
# animate(a, width=6, height=5.3, units="in", res = 300)
# 
